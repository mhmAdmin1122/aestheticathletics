...
const SectionOne = () => {
  return (
    <div className="relative h-[600px] shadow-md shadow-gray-300 bg-gray-200 rounded-lg overflow-hidden">
      <div className="absolute flex items-start h-[160px] w-[90px]">
        <div className="bg-[#44e02f] w-[30px] rounded-b-[40px] h-full"></div>
        <div className="bg-[#ff0000] w-[30px] rounded-b-[40px] h-[140px]"></div>
        <div className="bg-[#0000ff] w-[30px] rounded-b-[40px] h-[120px]"></div>
      </div>
      <div className="flex justify-center items-center w-full">
        <div className="w-[60%] pl-20">
          ...
          <p className="text-[18px] text-[#adadad] w-[70%]">
